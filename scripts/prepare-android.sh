...
echo "== Copying notification icon drawables =="
DRAWABLE_DEST="android/app/src/main/res/drawable"
mkdir -p "$DRAWABLE_DEST"
cp native-src/res/drawable/ic_notif_previous.xml "$DRAWABLE_DEST/"
cp native-src/res/drawable/ic_notif_play.xml "$DRAWABLE_DEST/"
cp native-src/res/drawable/ic_notif_pause.xml "$DRAWABLE_DEST/"
cp native-src/res/drawable/ic_notif_next.xml "$DRAWABLE_DEST/"
cp native-src/res/drawable/ic_notif_close.xml "$DRAWABLE_DEST/"
